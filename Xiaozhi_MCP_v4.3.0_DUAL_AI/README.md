...
Xiaozhi MCP Control Panel là phần mềm điều khiển máy tính Windows toàn diện thông qua giao thức MCP (Model Context Protocol), cho phép AI điều khiển máy tính của bạn với **38 công cụ** mạnh mẽ, bao gồm tích hợp **2 AI Engines**: **Google Gemini** (miễn phí) và **OpenAI GPT-4** (trả phí).
...
#### 🤖 AI Assistant (2 công cụ)
- **Google Gemini AI** (MIỄN PHÍ) - Hỏi đáp, phân tích, viết nội dung, 1500 requests/day
- **OpenAI GPT-4** (TRẢ PHÍ) - Code generation, reasoning, phân tích phức tạp
- Models: gemini-2.5-pro, gemini-2.5-flash, gpt-4o, gpt-4-turbo
...
- "Giá vàng hôm nay"
- "Hỏi Gemini: What is quantum computing?"
- "Khóa máy tính"
...
2. Đăng nhập Google và tạo API key
3. Thêm vào `xiaozhi_endpoints.json`:
   ```json
   {
     "endpoints": [...],
...
### Sử dụng
- **Qua AI**: "Hỏi Gemini: What is AI?"
- **Qua Dashboard**: Tab "Công Cụ" → Gemini AI section

### Models
- `gemini-2.0-flash-exp` (mặc định) - Cân bằng tốc độ và chất lượng
- `gemini-1.5-pro` - Chất lượng cao nhất
- `gemini-1.5-flash` - Nhanh nhất

Chi tiết: Xem [GEMINI_GUIDE.md](GEMINI_GUIDE.md)
...
## 🎯 Phiên bản hiện tại: v4.3.0 (Dual AI Edition)

**Cập nhật mới nhất:**
- 🎉 **2 AI ENGINES**: Google Gemini (FREE) + OpenAI GPT-4 (PAID)
- 🤖 Tool `ask_gemini()` - Miễn phí, nhanh, 1500 requests/day
- 🧠 Tool `ask_gpt4()` - Trả phí, mạnh nhất, code & reasoning
- 🆕 Auto-save cho CẢ 2 API keys trên Web UI
- 🆕 Hướng dẫn chi tiết: GEMINI_GUIDE.md & GPT4_GUIDE.md
- ✅ 38 công cụ điều khiển máy tính (36 tools + 2 AI)
