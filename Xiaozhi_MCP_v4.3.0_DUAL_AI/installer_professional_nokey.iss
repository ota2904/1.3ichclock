...
; NO LICENSE KEY REQUIRED - NO API KEYS EXPOSED
; Clean customer edition
; ============================================================
...
english.WelcomeLabel1=Welcome to miniZ MCP Professional
english.WelcomeLabel2=This will install miniZ MCP Professional v{#MyAppVersion} on your computer.%n%nFeatures:%n• 146+ AI Tools%n• Multi-device support%n• Voice assistant integration%n• Smart analysis with Gemini + Google%n%nClick Next to continue.

[Tasks]
Name: "desktopicon"; Description: "Create a desktop shortcut"; GroupDescription: "Additional shortcuts:"
Name: "startupicon"; Description: "Start with Windows (recommended)"; GroupDescription: "Startup options:"
...
; IMPORTANT: Do NOT include these files (contain sensitive data):
; - LICENSE_KEYS.json
...
begin
  ...
  begin
    ...
    // Create offline license file (auto-activate)
